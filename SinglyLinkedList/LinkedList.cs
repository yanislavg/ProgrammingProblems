namespace SinglyLinkedList
{
    ...
    public class LinkedList<T> : ICollection<T>
    {
        ...
        private void AddFirst(LinkedListNode<T> node)
        {
            ...
            if (Count == 1)
            {
                //if the list was empty then both Head and Tail should point to the new node
                Tail = Head;
            }
        }
        ...
        public void Clear()
        {
            // easy in garbage collected enviorment
            // just remove all the references
            Head = null;
            Tail = null;
            Count = 0;
        }
